                ...
                <li><a class="app-menu__item" href="principal.php"><i class="app-menu__icon fa fa-home fa-lg"></i><span
                    ...
                    <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                        ...
                        <ul class="treeview-menu">
                            <li><a class="treeview-item" href="asignar-cita.php"><i class="icon fa fa-circle-o"></i> Gestión citas</a></li>
                            <li><a class="treeview-item" href="gestion-paciente.php"><i class="icon fa fa-circle-o"></i> Listado de pacientes</a></li>
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-12">
                                    <a href="gestion-procedimientos.php" class="btn btn-warning btn-block btn-lg">
                                        <i class="fa fa-calendar-plus-o mr-2"></i> Gestión de procedimientos médicos
                                    </a>
                                </div>
                            </div>
